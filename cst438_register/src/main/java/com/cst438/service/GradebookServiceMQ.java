...
public class GradebookServiceMQ extends GradebookService {
    ...
    public void enrollStudent(String student_email, String student_name, int course_id) {
        EnrollmentDTO enroll = new EnrollmentDTO(student_email, student_name, course_id);
    ...
    public void receive(CourseDTOG courseDTOG) {
        ...
        for (CourseDTOG.GradeDTO grade : courseDTOG.grades) {
            String email = grade.student_email;
            Enrollment student = enrollmentRepository.findByEmailAndCourseId(email, courseDTOG.course_id);
            student.setCourseGrade(grade.grade);
